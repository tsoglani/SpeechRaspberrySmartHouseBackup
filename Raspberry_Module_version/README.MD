...
-raspberry_Module_InAndOut_40gpio_pin: 23 outputs 23 inputs ( if you want to use it with switches for example light switches ).
-raspberry_Module_Out_40gpio_pin: only outputs and no input ( 46 out 0 in).
