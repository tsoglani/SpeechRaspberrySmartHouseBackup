...
// api.openweathermap.org/data/2.5/find?q=London&type=accurate&mode=xml
// api.openweathermap.org/data/2.5/find?q=Tokyo&type=accurate&mode=xml
	private String baseOwmUrl = "http://api.openweathermap.org/data/2.5/";//http://api.openweathermap.org/data/2.1/";
	private String owmAPPID = "f53184d930bd6edc6a685079dea51beb";
	...
	public WeatherStatusResponse currentWeatherAtCity (String cityName, String countryCode) throws IOException, JSONException {
		String subUrl = String.format (Locale.ROOT, "find?q="+cityName+","+countryCode+"&type=accurate&mode=json", cityName, countryCode.toUpperCase ());
