...
-raspberry_1_InAndOut_40gpio_pin: 11 outputs 10 inputs ( if you want to use it with switches for example light switches ). -raspberry_1_Out_40gpio_pin: only outputs and no input ( 21 out 0 in).
