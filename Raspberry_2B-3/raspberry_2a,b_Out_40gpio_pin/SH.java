...
public class SH {
    ...
    //// user editable part
    // Pay attention on **
    private static  int NumberOfBindingCommands=15;// ** Number of commands you want to bind with one or more outputs.
